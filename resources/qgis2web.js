...
map.getView().fit([-12624655.633305, 1702708.114880, -9250883.028467, 3934836.171247], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Laboratorios Nacionales</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (217 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapa que contiene los datos de las instituciones asociadas y representantes que conforman los 116 Laboratorios Nacionales (LN), incluyendo su agrupación por el área temática predominante en la que busca incidir el LN.';
            }
